...
export default function FilterPanel() {
  ...
  // console.log(search, ":search", category, ":category", location, ":location");

  const router = useRouter();

  // const handleApplyFilters = () => {
  //   const params = new URLSearchParams();
  //   params.set("page", "1"); // নতুন filter দিলে page reset
  //   if (search) {
  ...
  const handleResetFilters = () => {
    ...
    setCategory("");
    setLocation("");
    router.push("/events"); // clean everything and send it to /events pg
  };
