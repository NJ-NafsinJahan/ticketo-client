  ...
  return (
    <div className="min-h-screen py-16 px-6 max-w-6xl mx-auto w-full space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="p-0 flex flex-col sm:flex-row items-center sm:items-start gap-6">
                <Image
                  src={
                    ...
                    (event.organization.logo.startsWith("http") ||
                      event.organization.logo.startsWith("/"))
                      ? event.organization.logo
                ...
                <div className="space-y-2 text-center sm:text-left">
                  ...
                  <p className="text-slate-400 text-xs leading-relaxed max-w-lg">
                    {event.organization?.description ||
                      "Curator of leading corporate panel discussions, tech events, and community music festivals."}
                  </p>
                  {event.organization?.website && (
                    <a
                      href={
                        event.organization.website.startsWith("http")
                          ? event.organization.website
                          : `https://${event.organization.website}`
                      }
                      target="_blank"
        ...
        <div className="space-y-6">booking section</div>
      </div>
    </div>
  );
}
