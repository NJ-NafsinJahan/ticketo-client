        ...
        {loading && (
          <div className="py-12 flex flex-col items-center justify-center gap-4 text-center">
            ...
            <h1 className="text-xl font-bold text-white mt-2">
              Verifying Upgrade Session...
            </h1>
            <p className="text-slate-400 text-xs max-w-xs leading-relaxed">
              We are connecting with Stripe to finalize your premium organizer
              upgrade. Do not refresh.
            </p>
          </div>
        )}
        ...
        {!loading && !success && (
          <CardBody className="py-8 flex flex-col items-center justify-center gap-4 text-center">
            ...
            <p className="text-slate-400 text-sm leading-relaxed max-w-sm">
              {error ||
                "We encountered an error validating your premium payment session. Please contact support."}
            </p>
            ...
            <div className="gap-6 bg-slate-900/40 p-6 rounded-2xl border border-white/5 text-center">
              <div className="space-y-4">
                ...
                <p className="text-slate-400 text-xs leading-relaxed max-w-md mx-auto">
                  The event limit has been permanently removed from your
                  account. You can now host unlimited events, manage ticket
                  configurations, and track complex ticket sales stats in real
                  time!
                </p>
              </div>
            </div>
